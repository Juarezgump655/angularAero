...
import { listaAerolineas, Aerolinea } from '../aerolinea';
import { AerolineaService } from '../aerolinea.service';
import { listaAeropuertos } from '../aeropuertos';
import { AeropuertosService } from '../aeropuertos.service';

@Component({
  selector: 'app-consultar-aerolineasaviones',
  templateUrl: './consultar-aerolineasaviones.component.html',
  styleUrls: ['./consultar-aerolineasaviones.component.css']
})
export class ConsultarAerolineasavionesComponent implements OnInit {
  shouldRun = true;
  ...
  seleccionar(id: number){
      this.router.navigate(['consultas-aerolineas-aviones/aviones',    this.id, id]);
